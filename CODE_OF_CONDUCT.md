# Averos Contributor Covenant Code of Conduct

## Our Pledge

We as members, contributors, and maintainers pledge to make participation
in the Averos project and community a harassment-free experience for
...
This Code of Conduct applies within all Averos project spaces — including
the repository (issues, pull requests, discussions), and any official
communication channels — and also applies when an individual is
officially representing the project in public spaces (e.g., using an
official email address, or posting via an official social media account).

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may
be reported to the maintainers at **averos.tech@gmail.com**. All
...
communication with the project for a specified period of time. No public
...
used under its CC BY 4.0 license, which explicitly permits and encourages
this kind of reuse and adaptation by open-source projects.
