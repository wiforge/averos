...
import { AverosEditEntityComponent } from '../../averos-edit-entity'
import { Indexable, UseCaseConfig, UseCaseViewLayout } from '@averos/core'

@Component({
  selector: 'averos-edit-entity-dialog',
  templateUrl: './averos-edit-entity-dialog.component.html',
  styleUrls: ['./averos-edit-entity-dialog.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  standalone: false,
})
export class AverosEditEntityDialogComponent<T extends Indexable> implements OnInit {
  ...
  @ViewChild('averosEditEntityComponent', { static: true })
  ...
  onCancel(data?: any) {
    if (this.averosEditEntityComponent.cancelUpdate()) {
  ...
  onSubmit() {
    this.averosEditEntityComponent.onSubmit()
  }
  submitToParentForm(entity: any) {
    this.submitForm.emit(entity)
  }
  disableSave(): boolean {
    return this.averosEditEntityComponent.disableSave()
  }
