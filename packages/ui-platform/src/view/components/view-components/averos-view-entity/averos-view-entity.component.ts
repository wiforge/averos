...
@Component({
  selector: 'averos-view-entity',
  templateUrl: './averos-view-entity.component.html',
  styleUrls: ['./averos-view-entity.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  standalone: false,
})
export class AverosViewEntityComponent<T extends Indexable> implements OnInit, OnDestroy {
