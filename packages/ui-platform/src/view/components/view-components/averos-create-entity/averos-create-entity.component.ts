...
@Component({
  selector: 'averos-create-entity',
  templateUrl: './averos-create-entity.component.html',
  styleUrls: ['./averos-create-entity.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  standalone: false,
})
export class AverosCreateEntityComponent<T extends Indexable> implements OnInit, OnDestroy {
